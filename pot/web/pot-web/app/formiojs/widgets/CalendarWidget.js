    ...
    value: function attach(input) {
      ...
      if (this._input) {
        ...
        this.addEventListener(this.calendar._input, 'blur', function (event) {
          ...
          if (((_event$relatedTarget = event.relatedTarget) === null || _event$relatedTarget === void 0 ? void 0 : _event$relatedTarget.className.trim()) !== 'flatpickr-day') {
            _this3.calendar.setDate(_this3.calendar._input.value, true, _this3.settings.altFormat);
          }
        });
      }
