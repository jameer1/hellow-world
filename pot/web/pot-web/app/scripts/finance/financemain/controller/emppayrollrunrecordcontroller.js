...
app.config(["$stateProvider", function($stateProvider) {
	$stateProvider.state("emppayrollrecord", {
		...
		views : {
			'content@' : {
				templateUrl : 'views/finance/financemain/employeewisecalc/employeepayrollrunrecords.html',
				controller : 'EmpPayRollRunRecordController'
			}
		}
	})
}]).controller("EmpPayRollRunRecordController", ["$scope", "$q", "$state", "ngDialog", "UserEPSProjectService", "GenerateInvoiceFactory", "GenericAlertService", function($scope, $q, $state, ngDialog, UserEPSProjectService,GenerateInvoiceFactory, GenericAlertService) {
