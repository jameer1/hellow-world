...
app.config(["$stateProvider", function($stateProvider) {
	$stateProvider.state("empcalcrecord", {
		...
		views : {
			'content@' : {
				templateUrl : 'views/finance/financemain/employeewisecalc/employeepaycalsheetrecords.html',
				controller : 'EmpPaySheetRecordController'
			}
		}
	})
}]).controller("EmpPaySheetRecordController", ["$scope", "$q", "$state", "ngDialog", "UserEPSProjectService", "GenerateInvoiceFactory", "GenericAlertService", function($scope, $q, $state, ngDialog, UserEPSProjectService,GenerateInvoiceFactory, GenericAlertService) {
