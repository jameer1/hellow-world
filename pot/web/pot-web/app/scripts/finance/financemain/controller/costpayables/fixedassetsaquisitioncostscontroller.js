...
app.config(["$stateProvider", function ($stateProvider) {
    $stateProvider.state("aquisitioncosts", {
        ...
        views: {
            'content@': {
                templateUrl: 'views/finance/financemain/costpayables/fixedassetsaquisitioncosts.html',
                controller: 'FixedAssetAquisitionCostController'
            }
        }
    })
}]).controller("FixedAssetAquisitionCostController", ["$scope", "$q", "$state", "ngDialog", "UserEPSProjectService", "GenerateInvoiceFactory", "GenericAlertService", "ProfitCentrePopUpFactory", "AssetCategorySelectFactory", "EpsProjectSelectFactory", function ($scope, $q, $state, ngDialog, UserEPSProjectService, GenerateInvoiceFactory, GenericAlertService, ProfitCentrePopUpFactory, AssetCategorySelectFactory, EpsProjectSelectFactory) {
