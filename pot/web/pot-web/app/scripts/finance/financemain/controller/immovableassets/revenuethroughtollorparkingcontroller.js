...
app.config(["$stateProvider", function ($stateProvider) {
    $stateProvider.state("revenuethroughtollorparking", {

        url: '/revenuethroughtollorparking',
        data: {
            roles: []
        },
        views: {
            'content@': {
                templateUrl: 'views/finance/financemain/immovableassets/revenuethroughtollorparking.html',
                controller: 'RevenueThroughTollOrParkingCollections'
            }
        }
    })
