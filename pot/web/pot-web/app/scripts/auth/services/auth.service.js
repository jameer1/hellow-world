...
app
    .factory('Auth', ["$rootScope", "$state", "$q", "Principal", "AuthServerProvider", "localStorageService", function($rootScope, $state, $q, Principal, AuthServerProvider, localStorageService) {
        return {
