...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "InvoiceService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, $rootScope,InvoiceService,
						GenericAlertService) {
															...
															InvoiceService
																	...
																	.then(
																			function(
																				...
																				GenericAlertService
																						.alertMessage(
																								'Purchase Wise Payment(s) are saved successfully',
																								"Info");
																				var returnPopObj = {
