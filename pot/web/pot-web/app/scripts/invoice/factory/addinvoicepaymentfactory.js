...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "InvoiceService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, $rootScope,
															...
															InvoiceService
																	...
																	.then(
																			function(
																				...
																				GenericAlertService
																						.alertMessage(
																								'Project Invoice(s) are saved successfully',
																								"Info");
																				var returnPopObj = {
