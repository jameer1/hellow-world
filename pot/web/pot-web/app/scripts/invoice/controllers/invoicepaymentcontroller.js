...
app
		...
		.controller(
				...
				["$rootScope", "$scope", "$state", "InvoiceService", "UserEPSProjectService", "PurchaseOrderService", "PreContractExternalService", "InvoiceWisePaymentFactory", "PurchaseOrderWisePaymentFactory", "GenericAlertService", "generalservice", function($rootScope, $scope, $state, InvoiceService,
						UserEPSProjectService, PurchaseOrderService,
						PreContractExternalService, InvoiceWisePaymentFactory,
						PurchaseOrderWisePaymentFactory, GenericAlertService,generalservice) {
