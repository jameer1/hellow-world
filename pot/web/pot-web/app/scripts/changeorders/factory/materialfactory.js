...
app.factory('MaterialFactory', ["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "MaterialClassService", "ProjectBudgetService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, $rootScope, MaterialClassService, ProjectBudgetService, GenericAlertService) {
	var service = {};
	service.getCentralMaterialClasses = function(projId, exitingSchMaterilMap) {
		console.log("getCentralMaterialClasses function");
		...
		MaterialClassService.getMaterialGroups(req).then(function(data) {
			console.log("getMaterialGroups function");
			var popupData = service.openPopup(projId, data.materialClassTOs, exitingSchMaterilMap);
		...
		var projMaterialPopup = ngDialog.open({
			...
			controller : [ '$scope', function($scope) {
				...
				$scope.addMaterialsToPreContact = function() {
					...
					console.log("addMaterialsToPreContact function");
