...
app.factory('ResourceCurvesFactory', ["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "GenericAlertService", "ResourceCurveService", function(ngDialog, $q, $filter, $timeout,$rootScope,GenericAlertService,ResourceCurveService) {
	var  popUp;
	var service = {};
