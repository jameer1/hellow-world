...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "EmpAttendanceService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, EmpAttendanceService,
						GenericAlertService) {
					var empDtlsPopup;
					var service = {};
															...
															EmpAttendanceService
																	...
																	.then(
																			function(
																				...
																				GenericAlertService
																						.alertMessage(
																								'Employee List(s) are saved successfully',
																								"Info");
																				var returnPopObj = {
