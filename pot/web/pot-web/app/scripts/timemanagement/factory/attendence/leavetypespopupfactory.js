...
app.factory('LeaveTypePopUpFactory', ["ngDialog", "$q", "$filter", "$timeout", "ProjLeaveTypeService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, ProjLeaveTypeService, GenericAlertService) {
	var leaveTypesPopup;
	var service = {};
