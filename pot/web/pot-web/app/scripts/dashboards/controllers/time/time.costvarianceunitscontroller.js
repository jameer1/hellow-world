...
app.config(["$stateProvider", function($stateProvider) {
	$stateProvider.state("costschedulevarianceunits", {
		...
		views : {
			'content@' : {
				'templateUrl' : 'views/dashboards/time/costandschedulevarianceunitsfilter.html',
				controller : 'TimeCostVarianceUnitsController'
			}
		}
	})
}]).controller("TimeCostVarianceUnitsController", ["$rootScope", "$scope", "$q", "$state", "ngDialog", "GenericAlertService", "UserEPSProjectService", 
			...
			function (newValue, oldValue) {
				if (newValue) {
					let columnDefs = [
						...
						{ field: 'scheduleVarienceDirectManHours', displayName: "Schedule Variance - Labour Hours", headerTooltip: "Schedule Variance - Labour Hours",
						...
						{ field: 'scheduleVarienceCost', displayName: "Schedule Variance - Cost", headerTooltip: "Schedule Variance - Cost",
						...
						{ field: 'costVarienceManHours', displayName: "Cost Variance - Labour Hours", headerTooltip: "Cost Variance - Labour Hours",
						...
						{ field: 'costVarience', displayName: "Cost Variance - Cost", headerTooltip: "Cost Variance - Cost", 
					...
					let data = [];
					$scope.gridOptions = ngGridService.initGrid($scope, columnDefs, data, "Dashboard_Time_CostScheduleVarinceUnits");
