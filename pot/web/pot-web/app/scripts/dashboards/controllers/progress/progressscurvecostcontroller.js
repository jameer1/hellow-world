...
app.config(["$stateProvider", function ($stateProvider) {
	$stateProvider.state("progressscurvecost", {
		url: '/progressscurvecost',
		data: {
			dashboards: []
		},
		...
		views: {
			'content@': {
				...
				'templateUrl': 'views/dashboards/progress/progress.scurvecostfilter.html',
				controller: 'ProgressSCurveCostController'
			}
		}
	})
}]).controller("ProgressSCurveCostController", ["$scope", "$q", "$filter", "uiGridGroupingConstants", "uiGridConstants", "stylesService", "ngGridService", "EpsProjectSelectFactory", "progressReportService", "GenericAlertService", "ProjectSettingsService",
	function ($scope, $q, $filter, uiGridGroupingConstants, uiGridConstants, stylesService, ngGridService, EpsProjectSelectFactory, progressReportService, GenericAlertService, ProjectSettingsService) {
	...
	$scope.generateReport = function() {
		...
		progressReportService.getProgressSCurveReportData({projIds: [$scope.searchFilter.projId], fromDate: $scope.searchFilter.fromDate, toDate: $scope.searchFilter.toDate}).then(function (data){
