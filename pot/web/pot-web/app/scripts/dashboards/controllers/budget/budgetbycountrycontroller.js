...
app.config(["$stateProvider", function ($stateProvider) {
	$stateProvider.state("budgetbycountry", {
		url: '/budgetbycountry',
		data: {
			dashboards: []
		},
		views: {
			'content@': {
				'templateUrl': 'views/dashboards/budget/budgetbycountryfilter.html',
				controller: 'BudgetByCountryController'
			}
		}
	})
}]).controller("BudgetByCountryController", ["$rootScope", "$scope", "$q", "$state", "ngDialog", "GenericAlertService", "UserEPSProjectService", 
	...
	$scope.getBudgetByCountryDetails = function () {
	...
	/*
	$scope.getBudgetByCountryDetails = function () {
		BudgetDashboardGroupingService.getBudgetDashboards($scope.selectedProjIds, "country").then(data => {
			setGraphData(data);
		});
	...
	*/
	...
	$scope.menuOptions = [['Chart type', [['Bar', function ($itemScope) {
	...
	HelpService.pageHelp = function () {
		...
		helppagepopup = ngDialog.open({
			template: 'views/help&tutorials/dashboardshelp/budget/budgetbycountryhelp.html',
