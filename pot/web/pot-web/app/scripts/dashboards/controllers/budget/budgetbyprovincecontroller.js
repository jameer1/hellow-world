...
app.config(["$stateProvider", function ($stateProvider) {
	$stateProvider.state("budgetbyprovince", {
		...
		views: {
			'content@': {
				'templateUrl': 'views/dashboards/budget/budgetbyprovincefilter.html',
				controller: 'BudgetByProvinceController'
			}
		}
	})
}]).controller("BudgetByProvinceController", ["$rootScope", "$scope", "$q", "$state", "ngDialog", "GenericAlertService", "UserEPSProjectService", 
	...
	$scope.getBudgetByProvinceDetails = function () {
	...
	/*
	$scope.getBudgetByProvinceDetails = function () {
		BudgetDashboardGroupingService.getBudgetDashboards($scope.selectedProjIds, "province").then(data => {
			setGraphData(data);
		});
	...
	*/
	...
	HelpService.pageHelp = function () {
		...
		helppagepopup = ngDialog.open({
			template: 'views/help&tutorials/dashboardshelp/budget/budgetbyprovincehelp.html',
