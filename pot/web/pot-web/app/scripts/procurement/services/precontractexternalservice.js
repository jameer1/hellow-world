 ...
 */
app.factory('PreContractExternalService', ["Restangular", function(Restangular) {
	return {
		getExternalPreContracts : function(req) {

			var contractDetails = Restangular.one("procurement/getExternalPreContracts")
					.customPOST(req, '', {}, {
		...
		getExternalPreContractPopupOnLoad : function(req) {
			var costCodes = Restangular.one("procurement/getExternalPreContractPopupOnLoad")
					.customPOST(req, '', {}, {
						ContentType : 'application/json'
					});
			return costCodes;
		...
		getPreContratCompanies : function(req) {
			var reqApprovals = Restangular.one("procurement/getPreContratCompanies").customPOST(
					req, '', {}, {
						ContentType : 'application/json'
					});
			return reqApprovals;
		...
		saveExternalPreContracts : function(req) {
			...
			var costSaveStatus = Restangular.one("procurement/saveExternalPreContracts")
					.customPOST(req, '', {}, {
						ContentType : 'application/json'
					});
		...
		savePreContractSOWTypes : function(req) {
			...
			var saveStatus = Restangular.one("procurement/savePreContractSOWTypes").customPOST(req,
					'', {}, {
						ContentType : 'application/json'
					});
			return saveStatus;
		...
		savePreContratCompanies : function(req) {
			...
			var saveStatus = Restangular.one("procurement/savePreContratCompanies").customPOST(req,
					'', {}, {
						ContentType : 'application/json'
					});
			return saveStatus;
		},
		saveSinglePurchaseOrder : function(req) {
			var resp = Restangular.one("procurement/saveSinglePurchaseOrder")
					.customPOST(req, '', {}, {
						ContentType : 'application/json'
					});
			return resp;
		},
		saveMultiPurchaseOrder : function(req) {
			var resp = Restangular.one("procurement/saveMultiplePurchaseOrder")
					.customPOST(req, '', {}, {
						ContentType : 'application/json'
					});
			return resp;
