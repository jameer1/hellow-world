...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "PreContractExternalService", "PreContractAddCompanyFactory", "GenericAlertService", "generalservice", function(ngDialog, $q, $filter, $timeout, $rootScope,
						PreContractExternalService,
						PreContractAddCompanyFactory, GenericAlertService,generalservice) {
