...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "PurchaseOrderService", "GenericAlertService", "ProjCostCodeService", "StoreService", "PrecontractDocUploadFactory", "PreContractCostPopupFactory", "PreContractProjEmpClassFactory", "PreContractProjPlantClassFactory", "PreContractProjServiceClassFactory", "PreContractMaterialClassFactory", "PreContractStoreFactory", "PreContractInternalService", "generalservice", function(ngDialog, $q, $filter, $timeout, $rootScope,
						...
						PreContractMaterialClassFactory,
						PreContractStoreFactory, PreContractInternalService,generalservice) {
