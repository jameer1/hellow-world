...
app
		.factory(
				'PurchaseFromVendorDetailsFactory',
					...
					var service = {};
							service.getFromVendorDetails = function(preContractCmpTO,
								...
								RFQService.getPreContratCmpDocsByType(req).then(
										function(data) {
											var docpopup = service.openPopup(
													data.preContractCmpDocsTOs, preContractCmpTO,
													companyMap, usersMap);
										...
										function(error) {
											GenericAlertService.alertMessage(
													"Error occured while getting vendor documents",
													'Error');
										});
							...
							service.openPopup = function(preContractCmpDocsTOs, preContractCmpTO,
								...
								var toVendorPopUp = ngDialog
										.open({
											template : 'views/procurement/purchaseorders/purchasefromvendor.html',
											showClose : false,
														...
														$scope.referDockObj = {
															...
															"projId" : preContractCmpTO.preContractTO.projId
																...
																$scope.saveVendorDocuments = function() {
																	...
																	RFQService
																			.savePreContratCompnayDocs(
																					req)
																			.then(
																					function(data) {
																						var succMsg = GenericAlertService
																								.alertMessageModal(
																										'Vendor Documents are saved successfully ',
																										'Info');
																						succMsg
																								.then(function(
																										popData) {
																					...
																					function(error) {
																						GenericAlertService
																								.alertMessage(
																										'Vendor Documents  are failed to Save',
																										'Error');
																					});
