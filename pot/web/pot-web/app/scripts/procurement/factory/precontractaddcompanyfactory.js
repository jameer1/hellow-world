...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "CompanyService", "PreContractExternalService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, $rootScope,
															...
															PreContractExternalService
																	...
																	.then(
																			...
																			function(
																				...
																				GenericAlertService
																						.alertMessage(
																								"Precontract companie(s) is/are added Successfully",
																								"Info");
																			},
