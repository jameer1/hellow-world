...
app
		.factory(
				...
				["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "$http", "FileUploader", "PreContractInternalService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, $rootScope,$http,
