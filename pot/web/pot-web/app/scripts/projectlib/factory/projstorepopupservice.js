'use strict';
app.factory('ProjStocksPopupService', ["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "blockUI", "ProjStoreStockService", "GenericAlertService", "generalservice", function(ngDialog, $q, $filter, $timeout, $rootScope,blockUI, ProjStoreStockService, GenericAlertService, generalservice) {
