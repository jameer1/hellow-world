 ...
 */
app.factory('ProjWorkShiftService', ["Restangular", function(Restangular) {
	return {
		...
		getWorkingShiftMap : function(req) {
			var map = Restangular.one("projectlib/getProjWorkShiftMap")
					.customPOST(req, '', {}, {
						ContentType : 'application/json'
					});
			return map;
