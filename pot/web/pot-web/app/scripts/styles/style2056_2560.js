 ...
 */
app.service('styles_2056_2560', function () {
    ...
    function styles50_50(me) {
        ...
        me.singleTableHeight = me.block * 0.84;

        // One table with fields on top and footer
        me.singleTableResHeight_2 = me.block * 0.85;
        me.singleTableHeight_2 = me.block * 0.78;
        ...
        // One table with 2 lines of fields and footer
        me.singleTableResHeight_12 = me.block * 0.85;
        me.singleTableHeight_12 = me.block * 0.75;
        ...
        // One table with 2 lines of fields and footer
        me.singleTableResHeight_4 = me.block * 0.30;
        me.singleTableHeight_4 = me.block * 0.24;
        ...
        me.firstTableResHeight = me.twinBlock * 0.75;
        me.firstTableHeight = me.twinBlock * 0.67;

        //Single table in first panel
        me.firstTableResHeight_1 = me.twinBlock * 0.80;
        me.firstTableHeight_1 = me.twinBlock * 0.75;

        me.tabTable_1_Res_height = me.twinBlock * 0.80;
        me.tabTable_1_height = me.twinBlock * 0.70;
        ...
        // One table with 2 lines of fields and footer
        me.tabTable_2_Res_height_12 = me.twinBlock * 0.70;
        me.tabTable_2_height_12 = me.twinBlock * 0.60;

        // Used in second table with nested tabs like tabMain -> tabSub -> Table
        me.tabTable_3_Res_height = me.twinBlock * 0.80;
        me.tabTable_3_height = me.twinBlock * 0.70;
        ...
        // One table with 2 lines of fields and footer
        me.singleTableResHeight_13 = me.block * 0.80;
        me.singleTableHeight_13 = me.block * 0.74;
        ...
        me.doubleHeaderTableResHeight = me.twinBlock * 0.75;
        me.doubleHeaderTableHeight = me.twinBlock * 0.60;

        me.tabTable_4_Res_Height = me.twinBlock * 0.60;
        ...
        //nested tab with textrow
        me.nestedTabTable_0_Res_Height = me.twinBlock * 0.60;
        me.nestedTabTable_0_Height = me.twinBlock * 0.45;

        //nested tab without textrow
        me.nestedTabTable_2_Res_Height = me.twinBlock * 0.70;
        me.nestedTabTable_2_Height = me.twinBlock * 0.60;

        //table in Tabs at two rows textboxes and tabs in third row
        me.tabTable_5_Res_Height = me.block * 0.75;
    ...
    function styles35_65(me) {
        ...
        me.topFooterTableResHeight = me.topBlock * 0.80;
        me.topFooterTableHeight = me.topBlock * 0.60;

        //top panel table(35:65)-table with footer along with panel header
        me.topHeaderFooterTableResHeight = me.topBlock * 0.70;
        me.topHeaderFooterTableHeight = me.topBlock * 0.60;
        ...
        me.tabR1Table_1_Res_height = me.bottomBlock * 0.82;
        me.tabR1Table_1_height = me.bottomBlock * 0.72;
        ...
        me.tabR1Table_2_Res_height = me.bottomBlock * 0.75;
        me.tabR1Table_2_height = me.bottomBlock * 0.60;

        //bottom panel table(35:65)-full table
        me.bottomTabTableResHeight = me.bottomBlock * 0.80;
        me.bottomTabTableHeight = me.bottomBlock * 0.74;

        //bottom panel table(35:65)-full table
        me.bottomTabTableResHeight_14 = me.bottomBlock * 0.80;
        me.bottomTabTableHeight_14 = me.bottomBlock * 0.68;
        ...
        me.bottomHeaderFooterTableResHeight = me.bottomBlock * 0.82;
        me.bottomHeaderFooterTableHeight = me.bottomBlock * 0.75;

        //bottom panel table(35:65)- table and footer buttons along with panel header 
        me.bottomDouleHeaderFooterTableResHeight = me.bottomBlock * 0.80;
        me.bottomDouleHeaderFooterTableHeight = me.bottomBlock * 0.60;
    ...
    function styles65_35(me) {
        ...
        //double table headers in single table at first panel
        me.doubleHeaderTableResHeight_topB = me.twinBlock * 0.95;
        me.doubleHeaderTableHeight_topB = me.twinBlock * 0.60;

        
        me.tabTable_1_Res_height_topB = me.twinBlock * 0.40;
        me.tabTable_1_height_topB = me.twinBlock * 0.23;

        me.tabTable_3_Res_height_topB = me.twinBlock * 0.40;
        me.tabTable_3_height_topB = me.twinBlock * 0.23;
