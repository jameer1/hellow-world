 ...
 */
app.service('styles_1366_1499', function () {
    ...
    function styles50_50(me) {
        ...
        me.singleTableHeight_2 = me.block * 0.75;
        ...
        // One table with 2 lines of fields and footer
        me.singleTableResHeight_4 = me.block * 0.60;
        me.singleTableHeight_4 = me.block * 0.53;
        ...
        me.firstTableResHeight = me.twinBlock * 0.59;
        me.firstTableHeight = me.twinBlock * 0.48;

        //Single table in first panel
        me.firstTableResHeight_1 = me.twinBlock * 0.80;
        me.firstTableHeight_1 = me.twinBlock * 0.75;

        me.tabTable_1_Res_height = me.twinBlock * 0.70;
        me.tabTable_1_height = me.twinBlock * 0.63;
        ...
        me.tabTable_2_Res_height = me.twinBlock * 0.50;
        me.tabTable_2_height = me.twinBlock * 0.45;

        //Used in Resources second panel -tab tables when textrows
        me.tabTable_2_10_Res_height = me.twinBlock * 0.50;
        me.tabTable_2__10_height = me.twinBlock * 0.45;

        // One table with 2 lines of fields and footer
        me.tabTable_2_Res_height_12 = me.twinBlock * 0.50;
        me.tabTable_2_height_12 = me.twinBlock * 0.40;

        // Used in second table with nested tabs like tabMain -> tabSub -> Table
        me.tabTable_3_Res_height = me.twinBlock * 0.70;
        me.tabTable_3_height = me.twinBlock * 0.50;
        ...
        me.doubleHeaderTableResHeight = me.twinBlock * 0.55;
        me.doubleHeaderTableHeight = me.twinBlock * 0.35;

        me.tabTable_4_Res_Height = me.twinBlock * 0.45;
        ...
        //nested tab with textrow
        me.nestedTabTable_0_Res_Height = me.twinBlock * 0.35;
        me.nestedTabTable_0_Height = me.twinBlock * 0.20;

        //nested tab without textrow
        me.nestedTabTable_2_Res_Height = me.twinBlock * 0.56;
        me.nestedTabTable_2_Height = me.twinBlock * 0.50;

        //table in Tabs at two rows textboxes and tabs in third row
        me.tabTable_5_Res_Height = me.block * 0.58;
    ...
    function styles35_65(me) {
        ...
        // One table with 2 lines of fields and footer
        me.singleTableResHeight_13 = me.block * 0.70;
        me.singleTableHeight_13 = me.block * 0.62;

        // One table with 2 lines of fields and footer
        me.tabTable_2_Res_height_12 = me.twinBlock * 0.48;
        me.tabTable_2_height_12 = me.twinBlock * 0.38;

        //bottom panel table with footer in (35:65)
        me.tabR1Table_1_Res_height = me.bottomBlock * 0.80;
        me.tabR1Table_1_height = me.bottomBlock * 0.75;
        ...
        me.tabR1Table_2_Res_height = me.bottomBlock * 0.62;
        ...
        //bottom panel table(35:65)-full table
        me.bottomTabTableResHeight_14 = me.bottomBlock * 0.75;
        me.bottomTabTableHeight_14 = me.bottomBlock * 0.55;
        ...
        me.bottomHeaderFooterTableResHeight = me.bottomBlock * 0.75;
        me.bottomHeaderFooterTableHeight = me.bottomBlock * 0.68;

        //bottom panel table(35:65)- table and footer buttons along with panel header 
        me.bottomDouleHeaderFooterTableResHeight = me.bottomBlock * 0.72;
        me.bottomDouleHeaderFooterTableHeight = me.bottomBlock * 0.35;
    ...
    function styles65_35(me) {
        ...
        //double table headers in single table at first panel
        me.doubleHeaderTableResHeight_topB = me.twinBlock * 0.84;
        me.doubleHeaderTableHeight_topB = me.twinBlock * 0.64;
