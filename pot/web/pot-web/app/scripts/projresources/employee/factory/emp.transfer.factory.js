'use strict';
app.factory('EmpTransferFactory', ["ngDialog", "$q", "$filter", "$timeout", "$rootScope", "EmpTransferService", "GenericAlertService", function(ngDialog, $q, $filter, $timeout, $rootScope, EmpTransferService, GenericAlertService) {
		...
		empTransferPopUp = ngDialog.open({
			...
			controller : [ '$scope', function($scope) {
				...
				$scope.getEmpTransferDetails = function() {
					...
					EmpTransferService.getEmpTransferDetails(req).then(function(data) {
