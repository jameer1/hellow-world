...
app.config(["$stateProvider", function ($stateProvider) {
    $stateProvider.state("periodicalprogressscurvecost", {
        url: '/periodicalprogressscurvecost',
        views: {
            'content@': {
                'templateUrl': 'views/reports/progress/progressscurvereport.html',
                controller: 'ProgressSCurveCostReportController'
            }
        }
    })
}]).controller("ProgressSCurveCostReportController", ["$scope", "$q", "$filter", "ngGridService", "EpsProjectSelectFactory", "progressReportService", "GenericAlertService", "ProjectSettingsService",
