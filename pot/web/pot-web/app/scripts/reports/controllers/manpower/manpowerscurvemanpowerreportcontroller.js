...
app.config(["$stateProvider", function ($stateProvider) {
    $stateProvider.state("manpowerscurvemanpower", {
        url: '/manpowerscurvemanpower',
        data: {
            progress: []
        },
        views: {
            'content@': {
                'templateUrl': 'views/reports/manpower/manpowerscurvemanpowerreport.html',
                controller: 'ProgressSCurveManpowerReportController'
            }
        }
    })
}]).controller("ProgressSCurveManpowerReportController", ["$scope", "$q", "$filter", "ngGridService", "EpsProjectSelectFactory", "progressReportService", "GenericAlertService", "ProjectSettingsService",
    ...
    $scope.gridOptions = ngGridService.initGrid($scope, columnDefs, [],"Reports_Progress_SCurve_Manpower");
