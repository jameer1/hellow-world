 ...
 */
app.factory('EmpService', ["Restangular", function(Restangular) {
	return {
		...
		getEmpClassMap : function(req) {
			var emp = Restangular.one("centrallib/getEmpClassMap").customPOST(req, '', {}, {
				ContentType : 'application/json'
			});
			return emp;
		},
		saveEmpClasses : function(req) {
			var resultStatus = Restangular.one("centrallib/saveEmpClasses").customPOST(req, '', {}, {
				ContentType : 'application/json'
			});
			return resultStatus;
		},
