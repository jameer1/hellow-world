 ...
 */
app.factory('WageService', ["Restangular", function(Restangular) {
	...
	return {
		...
		getEmpWageFactorMap : function(req) {
			var service = Restangular.one("centrallib/getEmpWageFactorMap").customPOST(req,
					'', {}, {
						ContentType : 'application/json'
					});
			return service;
