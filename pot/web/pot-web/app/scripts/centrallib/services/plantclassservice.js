 ...
 */
app.factory('PlantClassService', ["Restangular", function(Restangular) {
	return {
		...
		getPlantClassMap   : function(req) {
			var plant = Restangular.one("centrallib/getPlantClassMap").customPOST(req,
					'', {}, {
						ContentType : 'application/json'
					});
			return plant;
