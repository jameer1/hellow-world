...
app.factory('ProcureService', ["Restangular", function(Restangular) {
	return {
		...
		getProcureCatgClassMap : function(req) {
			var procure = Restangular.one("centrallib/getProcureCatgClassMap").customPOST(req,
					'', {}, {
						ContentType : 'application/json'
					});
			return procure;
