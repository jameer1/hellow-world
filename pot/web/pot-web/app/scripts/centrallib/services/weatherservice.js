 ...
 */
app.factory('WeatherService', ["Restangular", function(Restangular) {
	return {
		...
		getWeathersMap : function(req) {
			var weather = Restangular.one("centrallib/getWeathersMap").customPOST(req,
					'', {}, {
						ContentType : 'application/json'
					});
			return weather;
