...
public class SignInAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    @Override
    public void doFilterInternal(HttpServletRequest httpRequest, HttpServletResponse res, FilterChain chain)
        ...
        String token = (httpRequest.getHeader(ApplicationAuthConstants.POTTOKEN) == null)
                ? httpRequest.getParameter(ApplicationAuthConstants.POTTOKEN)
                : httpRequest.getHeader(ApplicationAuthConstants.POTTOKEN);
        ...
        super.doFilterInternal(httpRequest, res, chain);
    }
