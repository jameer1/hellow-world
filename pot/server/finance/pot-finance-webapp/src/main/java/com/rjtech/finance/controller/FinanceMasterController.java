...
public class FinanceMasterController {
    ...
    public ResponseEntity<UnitPayRateResp> saveUnitOfRates(@RequestBody UnitPayRateSaveReq unitPayRateSaveReq) {
        financeMasterService.saveUnitOfRates(unitPayRateSaveReq);
        ...
        unitPayRateResp.cloneAppResp(CommonUtil.getSaveAppResp());
    ...
    public ResponseEntity<VendorInvocieResponse> saveVendorPostInvoice(
    	...
    	System.out.println("finance save vendor invoce  controller");
    	financeMasterService.saveVendorPostInvoice(vendorInvoiceRequest);
    ...
    public ResponseEntity<VendorInvocieResponse> getVendorPostInvoice(@RequestBody GetVendorPostInvoiceRequest getVendorPostInvoiceRequest) {
    	System.out.println("*********** getVendorPostInvoice  *******************  ");
        return new ResponseEntity<VendorInvocieResponse>(financeMasterService.getVendorPostInvoice(getVendorPostInvoiceRequest),
                HttpStatus.OK);
    }
