...
public class ProjDocFolderHandler {
    ...
    public static ProjDocFolderTO convertEntityToPOJOdocument(ProjDocFolderEntity projDocFolderEntity, boolean addChild,Long projId,
      ...
      //  ProjDocFolderPermissionEntity projDocFolderPermissionEntity=projDocFolderEntity.p
        ...
        ProjDocFolderPermissionEntity projDocFolderPermissionEntity = projDocFolderPermissionRepository.findProjDocFolderPermissionsAndUser( projDocFolderEntity.getId(), userid, 1 );
        //if( projDocFolderPermissionEntity != null && projDocFolderPermissionEntity.getProjectEntity().getProjectId() == projId )
        if( projDocFolderPermissionEntity != null )
        {
        	projDocFolderTO.setIsReadAccess( projDocFolderPermissionEntity.isReadAccess() );
        	projDocFolderTO.setIsWriteAccess( projDocFolderPermissionEntity.isWriteAccess() );
        }
    ...
    public static ProjDocFolderEntity convertPOJOToEntity(ProjDocFolderEntity projDocFolderEntity,
        ...
        if( projDocFolderTO.getFolderType().equalsIgnoreCase("CUSTOM") )
        {
        	projDocFolderEntity.setFolderType("CUSTOM");
        	projDocFolderEntity.setUploadFolder("Other Documents");
        }
        System.out.println(projDocFolderEntity);
