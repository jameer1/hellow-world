...
public class UserMstrEntity implements Serializable {
    ...
    private String remarks;
	  ...
	  @OneToOne
	  @JoinColumn(name = "USR_ERD_ID") private EmpRegisterDtlEntityCopy empRegId;
	 
	  @ManyToOne
	  @JoinColumn(name = "USR_CRM_ID", referencedColumnName = "CRM_ID", nullable =
	  true) private ClientRegEntity clientRegEntity;
    ...
    public void setRemarks(String remarks) {
	  ...
	  public EmpRegisterDtlEntityCopy getEmpRegId() { return empRegId; }
	  
	  public void setEmpRegId(EmpRegisterDtlEntityCopy empRegId) { this.empRegId =
	  empRegId; }
	 

	
	  public ClientRegEntity getClientRegEntity() { return clientRegEntity; }
