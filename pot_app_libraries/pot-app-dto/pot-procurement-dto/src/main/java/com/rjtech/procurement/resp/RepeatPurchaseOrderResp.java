...
public class RepeatPurchaseOrderResp {

    private static final long serialVersionUID = 67657343465L;
    ...
    private boolean repeatPOInitiated = false;
    private boolean repeatPOApproved = false;
    private boolean repeatPOCreated = false;

    public RepeatPurchaseOrderResp() {
