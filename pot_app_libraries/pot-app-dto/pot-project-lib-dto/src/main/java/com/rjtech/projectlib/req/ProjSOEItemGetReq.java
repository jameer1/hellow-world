...
public class ProjSOEItemGetReq extends ProjectTO {
    ...
    private List<Long> soeParentIds;
    private List<Long> viewSoeIds;
    ...
    public List<Long> getSoeParentIds() {
        return soeParentIds;
    }

    public void setSoeParentIds(List<Long> soeParentIds) {
        this.soeParentIds = soeParentIds;
    }
 
    public List<Long> getViewSoeIds() {
        return viewSoeIds;
    }

    public void setViewSoeIds(List<Long> viewSoeIds) {
        this.viewSoeIds = viewSoeIds;
    }
