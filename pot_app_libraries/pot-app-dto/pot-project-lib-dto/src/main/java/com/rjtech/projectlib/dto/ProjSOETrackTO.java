...
public class ProjSOETrackTO extends ProjectTO {
    ...
    private List<ProjSOETrackTO> childSOEItemTOs = new ArrayList<ProjSOETrackTO>();
    ...
    public List<ProjSOETrackTO> getChildSOEItemTOs() {
        return childSOEItemTOs;
    }

    public void setChildSOEItemTOs(List<ProjSOETrackTO> childSOEItemTOs) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ProjSOETrackTO other = (ProjSOETrackTO) obj;
        if (id == null) {
            if (other.id != null)
                return false;
