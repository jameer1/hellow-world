...
public class ProjSORTrackTO extends ProjectTO {
...
//    private Character isExternalApprovalRequired;
 ...
 //   private Boolean isUserExternalApprover;  
    ...
    private List<ProjSORTrackTO> childSORItemTOs = new ArrayList<ProjSORTrackTO>();
    ...
    public List<ProjSORTrackTO> getChildSORItemTOs() {
        return childSORItemTOs;
    }

    public void setChildSORItemTOs(List<ProjSORTrackTO> childSORItemTOs) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ProjSORTrackTO other = (ProjSORTrackTO) obj;
        if (id == null) {
            if (other.id != null)
                return false;
...
//    }
	...
	/*
	 * public Long getExternalApprovalUserId() { return externalApprovalUserId; }
	 * 
	...
	/*
	 * public Long getInternalApprovalUserId() { return internalApprovalUserId; }
	 * 
	...
	/*
	 * public Long getOriginatorUserId() { return originatorUserId; }
	 * 
	...
	/*
	 * public Boolean getIsUserOriginator() { return isUserOriginator; }
	 * 
	...
	/*
	 * public Boolean getIsUserInternalApprover() { return isUserInternalApprover; }
	 * 
	...
	/*
	 * public Boolean getIsUserExternalApprover() { return isUserExternalApprover; }
	 * 
	 ...
	 * "sorStatus:"+sorStatus+" code:"+code+" id:"+id+" isUserInternalApprover:"
	 * +isUserInternalApprover+" isUserInternalApprover:"
	 * +isUserInternalApprover+" isUserExternalApprover:"+isUserExternalApprover; }
	 */
}
