...
public class MeasureUnitTO extends ClientTO {
    ...
    private ProcurementTO procurementTO;
    ...
    public ProcurementTO getProcurementTO() {
        return procurementTO;
    }

    public void setProcurementTO(ProcurementTO procurementTO) {
        this.procurementTO = procurementTO;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MeasureUnitTO other = (MeasureUnitTO) obj;
        if (id == null) {
            if (other.id != null)
                return false;
