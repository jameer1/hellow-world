...
public class EmpClassTO extends ClientTO {
    ...
    public boolean isEmpAssigned() {
        return empAssigned;
    }

    public void setEmpAssigned(boolean empAssigned) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        EmpClassTO other = (EmpClassTO) obj;
        if (id == null) {
            if (other.id != null)
                return false;
