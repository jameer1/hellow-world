...
public class CostReportTO implements Serializable, Cloneable {
    ...
    private static final long serialVersionUID = -8283495538679821157L;
	...
	public String toString() {
		return "CostReportTO [date=" + date + ", epsId=" + epsId + ", epsName=" + epsName + ", projId=" + projId
				+ ", projName=" + projName + ", cmpId=" + cmpId + ", cmpName=" + cmpName + ", costSubGroupId="
				+ costSubGroupId + ", costSubGroupCode=" + costSubGroupCode + ", costSubGroupName=" + costSubGroupName
				+ ", costItemId=" + costItemId + ", costItemCode=" + costItemCode + ", costItemName=" + costItemName
				+ ", resourceId=" + resourceId + ", empId=" + empId + ", empFirstName=" + empFirstName
				+ ", empLastName=" + empLastName + ", category=" + category + ", type=" + type + ", plantId=" + plantId
				+ ", plantDesc=" + plantDesc + ", plantRegNumber=" + plantRegNumber + ", plantMake=" + plantMake
				+ ", plantModel=" + plantModel + ", plantRateType=" + plantRateType + ", matId=" + matId
				+ ", materialSubGroupId=" + materialSubGroupId + ", materialSubGroupCode=" + materialSubGroupCode
				+ ", materialSubGroupName=" + materialSubGroupName + ", invoiceNumber=" + invoiceNumber
				+ ", invoiceDate=" + invoiceDate + ", ratePerUnit=" + ratePerUnit + ", unitOfMesure=" + unitOfMesure
				+ ", quantity=" + quantity + ", costAmount=" + costAmount + ", currencyCode=" + currencyCode
