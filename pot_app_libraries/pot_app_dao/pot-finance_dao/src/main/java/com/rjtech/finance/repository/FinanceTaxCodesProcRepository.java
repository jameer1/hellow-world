...
@Repository
public class FinanceTaxCodesProcRepository extends AbstractJDBCRepository {
    ...
    private static final String FINANCE_EMP_PAYMENT_CODES = "FINANCE_EMP_PAYMENT_CODES";

    @SuppressWarnings("unchecked")
    public List<LabelKeyTO> getFinanceTaxCodes(Long clientId, Long projId, Date startDate, String financeType) {
        CustomerStoredProcedure proc = new CustomerStoredProcedure(this.getJdbcTemplate().getDataSource(),
                FINANCE_EMP_PAYMENT_CODES);
        Map map = proc.getFinanceTaxCodes(clientId, projId, startDate, financeType);
    ...
    class CustomerStoredProcedure extends StoredProcedure {
        ...
        public Map getFinanceTaxCodes(Long clientId, Long projId, Date startDate, String financeType) {
