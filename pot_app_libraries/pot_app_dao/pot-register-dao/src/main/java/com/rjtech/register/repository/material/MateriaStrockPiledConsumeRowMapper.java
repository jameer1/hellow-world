...
public class MateriaStrockPiledConsumeRowMapper implements RowMapper<LabelKeyTO> {
    ...
    public LabelKeyTO mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        displayMap.put(RegisterConstants.OPEN_QTY, rs.getString(18));
        displayMap.put(RegisterConstants.CONSUMPTION_QTY, rs.getString(19));
        displayMap.put(RegisterConstants.CONSUMPTION_DATE, rs.getString(20));
        displayMap.put(RegisterConstants.NOTIFICATION_CODE, rs.getString(20));
