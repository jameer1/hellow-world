 ...
 * 
 * @Repository public interface WorkDairyNotificationRepositoryCopy extends
 * JpaRepository<WorkDairyNotificationsEntity, Long> {
 * 
 * @Modifying
 * 
 ...
 * List<WorkDairyNotificationsEntity>
 * findByWorkDairyId(@Param("additionalRequest") String additionalRequest,
 * 
 * @Param("notifyStatus") String notifyStatus, @Param("workDairyId") Long
 * workDairyId);
 * 
 * }
 */
