...
//import com.rjtech.register.EmpTransferReqApprEntity;
import com.rjtech.register.emp.model.EmpTransferReqApprEntity;
import com.rjtech.register.repository.emp.RegisterBaseRepository;
...
public interface EmpTransferReqAprRepository extends RegisterBaseRepository<EmpTransferReqApprEntity, Long> {
    ...
    @Query("SELECT T FROM EmpTransferReqApprEntity T WHERE T.empNotificationsEntity.id=:id")
    public EmpTransferReqApprEntity findEmpTransReqApprRecord(@Param("id") Long id);
