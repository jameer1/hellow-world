 ...
 * 
 * import com.rjtech.procurement.model.PreContractsCmpEntity; import
 * com.rjtech.procurement.model.PurchaseOrderEntity; //import
 * com.rjtech.procurement.model.copy.PreContractsCmpEntityCopy; //import
 * com.rjtech.procurement.model.copy.PurchaseOrderEntityCopy;
 * 
 * @Repository public interface PurchaseOrderRepositoryCopy extends
 * JpaRepository<PurchaseOrderEntity, Long> {
 * 
 ...
 * + "AND PUR.id= :poId") List<Object[]> getOriginalQtyOfPo(@Param("poId") Long
 * poId);
 * 
 * }
 */