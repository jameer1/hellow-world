...
public class TimeSheetEmpDetailsRowMapper implements RowMapper<LabelKeyTO> {
    ...
    public LabelKeyTO mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        displayMap.put(CommonConstants.CLASS_TYPE, rs.getString(8));
        displayMap.put(CommonConstants.BOOKED_HRS, rs.getString(9));
        displayMap.put(CommonConstants.TOTAL_HRS, rs.getString(10));
